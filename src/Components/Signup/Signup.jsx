        ...
        <div>
            ...
            <div className="lg:flex lg:items-center lg:mx-20">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-center">If you already have an account <Link to="/login"><span className="text-purple-700 font-semibold">Login</span></Link> here</p>
                    <form onSubmit={handleRegister} className="card-body">
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Name</span>
                            </label>
                            <input type="text" name="name" placeholder="name" className="input input-bordered border-purple-700 rounded-3xl" required />
                        </div>
                        <div className="form-control">
                            <label className="label">
                        ...
                        <div className="form-control">
                            ...
                            <input type="text" name="photo" placeholder="photo" className="input input-bordered border-purple-700 rounded-3xl" required />
                        </div>
                        {
                            errorMessage && <p className="text-center text-red-500">{errorMessage}</p>
                        }
                        <div className="mt-4 mx-auto">
                            <button className="btn normal-case px-5 border-none text-lg font-semibold bg-purple-600 text-white rounded-3xl hover:bg-fuchsia-500">Register</button>
                        </div>
                    </form>
                </div>
            </div>
