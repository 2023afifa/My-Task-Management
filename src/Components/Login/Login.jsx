                ...
                <div className="flex-1">
                    ...
                    <form onSubmit={handleLogin} className="card-body">
                        <div className="form-control">
                            ...
                            <input type="email" name="email" placeholder="email" className="input input-bordered border-blue-700 rounded-sm" required />
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Password</span>
                            </label>
                            <input type="password" name="password" placeholder="password" className="input input-bordered border-blue-700 rounded-sm" required />
                        </div>
                        {/* {
